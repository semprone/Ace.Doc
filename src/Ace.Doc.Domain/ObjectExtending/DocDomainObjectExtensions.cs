...
namespace Ace.Doc.ObjectExtending
{
    public static class DocDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the DocEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
